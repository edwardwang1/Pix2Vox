...
class CustomDataLoader:
    def __init__(self, cfg):
        ...
        self.rendering_image_path_template = cfg.DATASETS.CUSTOM.RENDERING_PATH
        self.volume_path_template = cfg.DATASETS.CUSTOM.VOXEL_PATH

        # Load all taxonomies of the dataset
        with open(cfg.DATASETS.CUSTOM.TAXONOMY_FILE_PATH, encoding='utf-8') as file:
    ...
    def get_dataset(self, dataset_type, n_views_rendering, transforms=None):
        ...
        return CustomDataset(dataset_type, files, n_views_rendering, transforms)
