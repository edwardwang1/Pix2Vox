...
def train_net_custom(cfg):
    ...
    # Set up data loader
    train_dataset_loader = utils.data_loaders.DATASET_LOADER_MAPPING[cfg.DATASET.CUSTOM_TRAIN_DATASET](cfg)
    val_dataset_loader = utils.data_loaders.DATASET_LOADER_MAPPING[cfg.DATASET.CUSTOM_TEST_DATASET](cfg)
    ...
    for epoch_idx in range(init_epoch, cfg.TRAIN.NUM_EPOCHES):
        ...
        for batch_idx, (taxonomy_names, sample_names, rendering_images,
            ...
            print('[INFO] %s [Epoch %d/%d][Batch %d/%d] BatchTime = %.3f (s) DataTime = %.3f (s) EDLoss = %.4f' % \
                (dt.now(), epoch_idx + 1, cfg.TRAIN.NUM_EPOCHES, batch_idx + 1, n_batches, \
                    batch_time.val, data_time.val, encoder_loss.item()))
        ...
        iou = test_net_custom(cfg, epoch_idx + 1, output_dir, val_data_loader, val_writer, encoder, decoder, merger)
